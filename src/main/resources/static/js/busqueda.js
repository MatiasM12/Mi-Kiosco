...
var busqueda = localStorage.getItem("ultimaBusqueda");
...
function main() {
	miH1.textContent = busqueda;
    obtenerProductos("https://kiosco-production.up.railway.app/productsByName/"+busqueda.toLowerCase());
    botonVerMas();
}
